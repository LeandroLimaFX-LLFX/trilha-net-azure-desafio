...
namespace TrilhaNetAzureDesafio.Controllers
{
    ...
    public class FuncionarioController : ControllerBase
    {
        ...
        public IActionResult Criar([FromBody] Funcionario funcionario)
        {
            ...
            var funcionarioLog = new FuncionarioLog(funcionario, TipoAcao.Inclusao, funcionario.Departamento ?? "default", Guid.NewGuid().ToString());
        ...
        public IActionResult Atualizar(int id, [FromBody] Funcionario funcionario)
        {
            ...
            var tableClient = GetTableClient();
            var funcionarioLog = new FuncionarioLog(funcionarioBanco, TipoAcao.Atualizacao, funcionarioBanco.Departamento ?? "default", Guid.NewGuid().ToString());
            tableClient.UpsertEntity(funcionarioLog);
        ...
        public IActionResult Deletar(int id)
        {
            ...
            var tableClient = GetTableClient();
            var funcionarioLog = new FuncionarioLog(funcionarioBanco, TipoAcao.Remocao, funcionarioBanco.Departamento ?? "default", Guid.NewGuid().ToString());
            tableClient.UpsertEntity(funcionarioLog);
